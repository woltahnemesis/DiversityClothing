...
namespace DiversityClothing.Models
{
    ...
    public partial class DiversityClothingContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        public DiversityClothingContext()
        {
        }

        public DiversityClothingContext(DbContextOptions<DiversityClothingContext> options)
            : base(options)
        {
        }
...
//                optionsBuilder.UseSqlServer("Data Source=(local);Initial Catalog=DiversityClothing;Integrated Security=True");
            }
        }
