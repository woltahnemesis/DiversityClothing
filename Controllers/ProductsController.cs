...
namespace DiversityClothing.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(DiversityClothingContext context)
        {
            _context = context;
        }
        ...
        {
            var diversityClothingContext = _context.Product.Include(p => p.Category);
            return View(await diversityClothingContext.ToListAsync());
        }
        ...
        {
            // add .OrderBy clause to the category query. c is a parameter that represents all
            // of the category data from the query. => is a "lamba" or "fat-arrow" operator representing 
